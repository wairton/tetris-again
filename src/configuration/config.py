...
ANTI_ROTATE_BUTTON = os.path.join(IMG_PATH, "Anti-rotate.png")
ROTATE_BUTTON = os.path.join(IMG_PATH, "Rotate.png")
FONTS_PATH = os.path.join(RES_PATH, 'fonts')
DOWN_BUTTON = os.path.join(IMG_PATH, "Down.png")
GROUND_BUTTON = os.path.join(IMG_PATH, "Ground.png")
HOLD_BUTTON = os.path.join(IMG_PATH, "Hold.png")
LEFT_BUTTON = os.path.join(IMG_PATH, "Left.png")
RIGHT_BUTTON = os.path.join(IMG_PATH, "Right.png")
